...
We support a wide range of standard image formats including:
-   **JPEG (`.jpg`):** Standard for photography.
-   **TIFF (`.tif`):** Standard for archival and high-quality imaging.
-   **PNG (`.png`):** Standard for lossless web graphics.
