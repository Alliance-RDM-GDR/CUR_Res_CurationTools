...
<p style="font-size: 1.5rem; opacity: 0.9; font-family: 'Montserrat', sans-serif;">Expert Workflows for Digital Curation</p>
:::

::: {.callout-important title="Work in Progress"}
This resource is currently under development. Please note that the French version is in progress. For feedback, questions, or suggestions, please contact us at [curators@frdr-dfdr.ca](mailto:curators@frdr-dfdr.ca).
:::
...
::: {.g-col-12 .g-col-md-4 .nav-card .p-3}
<h3 class="nav-card-title">📊 Systematic Reporting</h3>
